...
(function() {
  var $, Ansi, CLASS_ANSI, CLASS_BLURRED, CLASS_CURSOR, CLASS_HEADER, CLASS_INPUT, CLASS_OLD_PROMPT, CLASS_PREFIX, CLASS_PROMPT, DEFAULT_INDENT_WIDTH, DEFAULT_PROMPT_CONINUE_LABEL, DEFAULT_PROMPT_LABEL, EMPTY_DIV, EMPTY_SELECTOR, EMPTY_SPAN, ESCAPE_CHAR, ESCAPE_SYNTAX, E_KEYPRESS, JQConsole, KEY_A, KEY_BACKSPACE, KEY_DELETE, KEY_DOWN, KEY_E, KEY_END, KEY_ENTER, KEY_HOME, KEY_K, KEY_LEFT, KEY_PAGE_DOWN, KEY_PAGE_UP, KEY_RIGHT, KEY_TAB, KEY_U, KEY_UP, NEWLINE, STATE_INPUT, STATE_OUTPUT, STATE_PROMPT, spanHtml,
  ...
  JQConsole = (function() {
    ...
    JQConsole.prototype._HandleCtrlShortcut = function(key) {
      ...
      switch (key) {
        ...
        case KEY_A:
          ...
          break;
        case KEY_K:
          this._Delete(false, true);
          break;
        case KEY_U:
          this._Backspace(false, true);
          break;
        default:
    ...
    JQConsole.prototype._Delete = function(whole_word, whole_line) {
    ...
    JQConsole.prototype._Backspace = function(whole_word, whole_line) {
