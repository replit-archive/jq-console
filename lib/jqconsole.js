...
(function() {
  ...
  JQConsole = (function() {
    ...
    JQConsole.prototype.ScrollWindowToPrompt = function() {
      var alignWithTop, element, leftWidth, overBottom, overLeft, overRight, overTop, parent, parentBorderLeftWidth, parentBorderTopWidth, parentComputedStyle, topWidth;
      ...
      if (element.scrollIntoViewIfNeeded) {
        ...
        if (overTop || overBottom || overLeft || overRight) {
          return element.scrollIntoView(alignWithTop);
        }
      }
    };
